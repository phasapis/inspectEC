...
import eu.inspect.rest.api.citizen.IncidentReportController;
	...
	public ResponseEntity<ApplicationResponseMessageBase> initMultimediaAnalysis(@RequestBody MultimediaFilesAnalysisDescriptor multimediaFilesAnalysisDescriptor)
        {
            ...
            while(mediaIterator.hasNext())
            {
                ...
                {
                    Logger.getLogger(IncidentReportController.class.getName()).log(Level.SEVERE, "Media Descriptor required fields are missing");
